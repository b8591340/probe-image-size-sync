// noinspection HtmlRequiredLangAttribute,CheckTagEmptyBody

import assert from "node:assert";
import fs from "node:fs";
import path from "node:path";
import { str2arr } from "../lib/common.js";
...
describe("File formats", function () {
	...
	describe("JPEG (sync)", function () {
		...
		it("coverage - 0xE1 segment but not exif", async function () {
			let buf = Buffer.from(
				"FFD8 FFE10010AAAAAAAAAAAAAAAAAAAAAAAAAAAA FFC00011 08000F000F03012200021101031101 FFFFD9".replace(/ /g, ""),
				"hex"
			);
